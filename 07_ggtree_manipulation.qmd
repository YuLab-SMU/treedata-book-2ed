...
p_height_default <- collapse(p_height_base, node, 'mixed')
p_height_relative <- collapse(p_height_base, node, 'mixed', height = ggplot2::rel(0.2))
p_height_fixed <- collapse(p_height_base, node, 'mixed', height = 1)
