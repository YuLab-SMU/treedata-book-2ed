...
The `height` parameter can be used to control the displayed height of collapsed triangles. It supports three input forms: `NULL` (default, do nothing), `ggplot2::rel()` to scale the original triangle height relatively, and a numeric value to force an absolute displayed height. This is useful when multiple collapsed clades should have a comparable visual footprint (Figure @fig-collapseHeight).
...
#| fig-cap: |
#|   Controlling the displayed height of collapsed triangles.
#| fig-subcap:
#|   - "Default height"
