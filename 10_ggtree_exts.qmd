...
# ggtreeExtra for Presenting Data on a Circular Layout {#sec-chapter10}
...
#| fig-scap: "Phylogenetic tree with OTU abundance distribution"
#| out-extra: ''
#| warning: false
#| out-width: "100%"
library(ggtreeExtra)
...
## Aligning Multiple Graphs to the Tree for Multi-dimensional Data {#sec-geom-fruit2}

We are able to add multiple `geom_fruit()`\index{geom\textunderscore fruit} layers to a tree and the circular layout is indeed more compact and efficient for multi-dimensional data. This example reproduces figure 2 of [@morgan2013HMP]. The data is provided by GraPhlAn [@GraPhlAn], which contained the relative abundance of the microbiome at different body sites. This example demonstrates the ability to add multiple layers (heat map and bar plot) to present different types of data (Figure @fig-HMPplot)\index{microbiome}. This figure is also an interactive one, where you can hover over the branches, nodes, and other graphical elements to explore the data. For more details on creating interactive `ggtree` plots, please refer to [Chapter 5](#sec-interactive-ggtree).
...
#| fig-scap: "HMP microbiome data visualization"
#| out-extra: ''
#| out-width: "100%"
library(ggtreeExtra)
library(ggtree)
...
#| fig-scap: "Illustration of using geom_fruit() in rectangular tree layout"
#| out-extra: ''
#| out-width: "100%"
...
#| fig-width: 7
#| fig-height: 7
#| label: fig-Styphiplot
#| warning: false
#| message: false
#| fig-cap: |
#|   **Population structure of the 1,832 *S. Typhi* isolates**.
#| fig-scap: "Population structure of the S. Typhi isolates"
#| out-extra: ''
#| out-width: "100%"
library(ggtreeExtra)
library(ggtree)
